...
export const EXTENDED_EVIDENCE = [
  ...
  {id:'TCATLAS1-010',source:'TCATLAS1',page:10,topics:['bệu','mập','hình thể rộng','rêu trắng vàng'],text:'Trang 10 mô tả lưỡi đỏ, bệu, rêu trắng kiêm vàng. Nhãn “bệu” là mô tả hình thể nguồn; khi số hóa nên tách hình thể rộng/đầy nhìn thấy khỏi thuộc tính mềm/non vốn không thể xác nhận chắc chắn từ ảnh tĩnh.'},
  {id:'TCATLAS1-012',source:'TCATLAS1',page:12,topics:['mỏng nhỏ','gầy','hình thể hẹp','rêu dày'],text:'Trang 12 mô tả lưỡi trắng nhạt, mỏng nhỏ, rêu dày vàng kiêm trắng; đây là ví dụ nguồn cho hình thể hẹp/mỏng nhưng không phải ngưỡng hình học phổ quát.'},
  {id:'TCATLAS1-020',source:'TCATLAS1',page:20,topics:['phình to','bệu','mập','rêu trắng dày'],text:'Trang 20 mô tả lưỡi trắng nhợt, phình to với rêu trắng dày. Ảnh nguồn hỗ trợ thuật ngữ “phình to/mập-bệu”, nhưng thuật toán chỉ được dùng hình học tương đối của silhouette, không dùng kích thước tuyệt đối vì khoảng cách camera thay đổi.'},
  {id:'TCATLAS1-033',source:'TCATLAS1',page:33,topics:['non bệu','rêu dày','trắng nhuận','trơn'],text:'Trang 33 mô tả lưỡi trắng nhợt, non bệu, rêu dày trắng nhuận mà trơn. Ảnh tĩnh có thể hỗ trợ hình thể rộng/đầy và bề mặt trơn/nhuận; riêng tính “non/mềm” cần thận trọng vì không phải thuộc tính hình học thuần túy.'},
  {id:'TCATLAS1-036',source:'TCATLAS1',page:36,topics:['rêu bong tróc','rêu bẩn','peeled','patchy'],text:'Trang 36 mô tả rêu bong tróc bẩn. Đây là mẫu giáo khoa cho kết cấu rêu không liên tục/dạng mảng; chỉ dùng như silver teaching reference, không phải clinical gold.'},
  {id:'TCATLAS1-037',source:'TCATLAS1',page:37,topics:['rêu thô','texture','trắng nhạt'],text:'Trang 37 mô tả rêu trắng thô; thuật ngữ này hỗ trợ lớp mô tả texture thô/không đều, không tự mang ý nghĩa bệnh danh.'},
  {id:'TCATLAS1-039',source:'TCATLAS1',page:39,topics:['rêu dày','trắng trơn','texture','mịn'],text:'Trang 39 mô tả rêu dày, trắng trơn. Đây là mẫu nguồn để đối chiếu bề mặt tương đối mịn/trơn, nhưng ảnh không xác định được độ dính hay khả năng cạo rêu.'},
