...
assert.match(sw,/ai-thiet-chan-v2\.9\.13-consult-camera-lock/);
...
console.log('THAM VAN / CONSULTATION LOCK SMOKE PASS: branded UI override, Gemini-only external consultation, [A.I] grounding, camera shutdown, full-tongue landmark guidance, and QC-qualified >=85% multi-atlas wording are present.');
