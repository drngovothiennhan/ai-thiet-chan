...
try{
  ...
  requireMarkers(settings,['beforeinstallprompt','pwaInstallBtn',"const RELEASE='2026.09.21-responsive-shell-r2'",'/ui-controls.js','/admin-center.js','/admin-credentials.js','/feedback-lifecycle.js','/upload-controls.js'],'settings');
