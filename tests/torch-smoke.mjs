...
for(const marker of ["load('/torch.js','rearTorch')","const RELEASE='2026.09.20-responsive-admin-r1'"]) if(!settings.includes(marker)) throw new Error(`torch loader missing: ${marker}`);
