    ...
    if(!$('adminCenterDialog')){
      ...
      d.innerHTML=`<div class="admin-center-panel">
        ...
        <section id="adminDashboard" hidden>
          ...
          <div class="admin-stat-grid"><div><span>A.I Gemini</span><strong id="adminAiState">—</strong></div><div><span>Kho dữ liệu</span><strong id="adminStoreState">—</strong></div><div><span>Ca đã thu thập</span><strong id="adminCaseCount">—</strong></div><div><span>Góp ý chờ duyệt</span><strong id="adminPendingCount">—</strong></div><div><span>Kiến thức đã duyệt</span><strong id="adminLearnedCount">—</strong></div><div><span>Bản backup</span><strong id="adminBackupCount">—</strong></div></div>
