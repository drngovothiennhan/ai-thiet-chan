...
assert.ok(home.includes('/release-ui.js?v=2026.09.21-responsive-shell-r2')&&home.includes('/release-ui.css?v=2026.09.21-responsive-shell-r2'),'PWA shell must version responsive taskbar assets');
