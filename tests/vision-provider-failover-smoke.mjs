...
console.log('VISION PROVIDER FAILOVER SMOKE PASS: transient Gemini 3.8 vision failure retries once on Gemini 3.6, returns real multimodal output, and never fabricates a local visual result.');
