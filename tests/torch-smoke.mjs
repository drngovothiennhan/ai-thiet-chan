...
for(const marker of ["load('/torch.js','rearTorch')","const RELEASE='2026.09.21-recognition-prod-r1'"]) if(!settings.includes(marker)) throw new Error(`torch loader missing: ${marker}`);
