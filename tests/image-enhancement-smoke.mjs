...
const appAt=index.indexOf('<script src="/app.js');
const enhanceAt=index.indexOf('<script src="/image-enhancement.js');
const captureAt=index.indexOf('<script src="/capture-metadata.js');
