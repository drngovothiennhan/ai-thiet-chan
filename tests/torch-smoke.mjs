...
for(const marker of ["load('/torch.js','rearTorch')","const RELEASE='2026.09.21-responsive-shell-r2'"]) if(!settings.includes(marker)) throw new Error(`torch loader missing: ${marker}`);
