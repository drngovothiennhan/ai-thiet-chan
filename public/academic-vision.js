(function(scope){
'use strict';
const SOURCE=Object.freeze({id:'HD1',pdfPages:350,indexedPages:350,visualSignaturePages:263,sha256:'d05dedaeffcfcde847765739e744e987ebeaa8802d67990141af3688df6d282a'});
...
async function signatureFromDataUrl(dataUrl){
  ...
  try{
    ...
    if(den<50)return null;const q=v=>Number(v.toFixed(4));
    return {r:q(sr/den),g:q(sg/den),b:q(sb/den),s:q(ss/den),v:q(sv/den),purple:q(purple/den),white:q(white/den),yellow:q(yellow/den),dark:q(dark/den),spot:q(spot/den),aspect:q(bw/bh),coverage:q(comp.area/n)};
