...
assert.match(server,/morphologyReferenceIsComparatorOnly:true/);
assert.match(server,/morphologyReference:top\.morphologyReference/);
assert.match(engine,/evaluateMorphologyReference/);
assert.match(engine,/MORPHOLOGY_REFERENCE_MODEL_VERSION/);
