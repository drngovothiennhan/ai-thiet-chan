...
for(const marker of ['topFileInput','bottomFileInput','topUploadBtn','bottomUploadBtn','Tải ảnh mặt trên','Tải ảnh mặt dưới','input.click()']){
...
console.log('UPLOAD CONTROLS SMOKE PASS: existing images use the same QC and AI analysis pipeline');
